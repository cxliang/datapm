...
* [GrowingIO](https://www.growingio.com/)：国内第一个无埋点用户行为分析平台：增长，源自对每一个用户行为的洞察
* [Amplitude](https://amplitude.com/)：real-time mobile analytics with all data provided in redshift
* [神策数据](https://www.sensorsdata.cn/)：可以私有化部署的用户行为分析产品
...
* Palantir : 对接客户部分数据，结合第三方数据进行风险控制，反欺诈，金融问题追踪，精准营销等服务

* 第四范式：对接客户部分数据，结合第三方数据提供风险评估或做精准营销

* Everstring：对接客户CRM数据，并与自己的第三方建模数据进行匹配后为客户提供销售成功性打分，提高销售成功率
